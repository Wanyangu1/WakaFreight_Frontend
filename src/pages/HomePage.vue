...
const heroSlides = [
  ...
  },
  {
    ...
    subtitle:
      'Time-sensitive global air cargo with customs clearance and dedicated air charter services',
    cta1: 'Get Air Quote',
    cta2: 'Learn More',
  },
  {
...
const services = [
  {
    title: 'Air Freight',
    description:
      'Time-sensitive global air cargo solutions with customs clearance. Our dedicated air charter services ensure your urgent shipments arrive on schedule.',
    image: airfreightImg,
    features: [
  ...
  },
  {
    title: 'Sea Freight',
    description:
      'Cost-effective ocean shipping with port-to-door logistics. We offer FCL, LCL, and specialized container solutions.',
    image: seaFreightImg,
    features: [
  ...
  },
  {
    title: 'Cross-Border',
    description:
      'Efficient land freight across East African borders with our fleet of modern trucks and experienced drivers.',
  ...
  },
  {
    ...
    description:
      'Expert documentation and tax compliance services to ensure smooth clearance at all border points.',
    image: customsImg,
    features: [
  ...
  },
  {
    title: 'Warehousing',
    description:
      'Secure storage with inventory management, pick & pack, and distribution services across our regional hubs.',
  ...
  },
  {
    ...
    description:
      'End-to-end new/used vehicle importation with customs clearance and inland delivery.',
...
<template>
  <div class="font-sans antialiased text-gray-900 bg-white">
    ...
    <section
      class="relative h-[90vh] lg:min-h-[600px] overflow-hidden"
    ...
    >
      ...
      <div class="relative h-full w-full">
        <div
          ...
          :key="index"
          class="absolute inset-0 transition-opacity duration-1000 ease-[cubic-bezier(0.65,0,0.35,1)]"
          :class="{
        ...
        >
          ...
          <div class="absolute inset-0 z-0 overflow-hidden">
            <img
              :src="slide.image"
              :alt="slide.title"
              class="w-full h-full object-cover object-center transition-transform duration-[8000ms] ease-out"
              :class="{
          ...
          <!-- Content -->
          <div
            class="relative z-10 h-full flex flex-col justify-center px-6 md:px-16 lg:px-24 text-white"
          >
            <div
              class="mb-6 transition-all duration-700 ease-[cubic-bezier(0.65,0,0.35,1)] delay-100"
              :class="{
            ...
            <p
              class="text-xl md:text-2xl max-w-3xl leading-relaxed opacity-90 mb-10 transition-all duration-700 ease-[cubic-bezier(0.65,0,0.35,1)] delay-300"
              :class="{
                'opacity-100 translate-y-0': currentSlide === index,
                'opacity-0 translate-y-4': currentSlide !== index,
              }"
    ...
    <section
      class="py-6 bg-gradient-to-r from-blue-900 to-blue-800 text-white relative overflow-hidden"
    >
      ...
      <div class="container mx-auto px-6 relative z-10">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div
            ...
            :key="index"
            class="stat-item opacity-0 translate-y-10 transition-all duration-500"
          ...
          >
            ...
            >
              <div class="flex flex-col items-center text-center">
                <div
                  class="text-3xl md:text-3xl font-bold text-white mb-1 counter"
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative overflow-hidden py-8">
          ...
          <div class="flex space-x-12 animate-marquee whitespace-nowrap">
            <div
              v-for="(client, index) in [...clientLogos, ...clientLogos]"
              :key="'first-' + index"
        ...
        <div class="relative">
          ...
          <div class="lg:hidden flex justify-center mb-12">
            <div class="flex items-center">
              ...
              >
                <div
                  class="w-12 h-12 rounded-full bg-blue-600 text-white flex items-center justify-center mb-2 z-10"
                >
    ...
    <!-- Testimonials -->
    <section
      class="py-16 md:py-24 bg-gradient-to-br from-blue-900 to-blue-800 text-white relative overflow-hidden"
    >
      <!-- Decorative elements -->
      <div class="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-blue-700/20 blur-3xl"></div>
      <div
        class="absolute -bottom-20 -left-20 w-64 h-64 rounded-full bg-blue-700/20 blur-3xl"
      ></div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            >
              WakaFreight' s cross-border service transformed our regional distribution. Their team
              understands East African trade regulations better than anyone.
            </p>
          ...
          >
            ...
            <p
              class="italic mb-6 relative pl-6 before:content-before:text-4xl before:text-blue-400/30 before:absolute before:left-0 before:-top-2"
            >
              As a vehicle importer, I rely on WakaFreight' s Mombasa port operations. Their customs
              clearance team saves me 2-3 weeks on every shipment.
            </p>
            <div class="flex items-center justify-between">
              <div class="flex text-yellow-400">
                <i class="fas fa-star"></i>
          ...
          >
              ...
              <div class="relative">
                ...
                >
                  <img
                    ...
                    alt="Dar es Salaam businesswoman"
                    class="w-full h-full object-cover"
                  />
                </div>
                <div
            ...
            <p
              class="italic mb-6 relative pl-6 before:content-before:text-4xl before:text-blue-400/30 before:absolute before:left-0 before:-top-2"
            >
              Their temperature-controlled air freight from Europe ensures our medical supplies
              arrive in perfect condition. 24/7 tracking gives us peace of mind.
            </p>
            <div class="flex items-center justify-between">
              <div class="flex text-yellow-400">
                <i class="fas fa-star"></i>
        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
          ...
          <div class="w-full lg:w-1/2">
            <h2 class="text-3xl md:text-4xl font-bold mb-6 leading-tight">
              Ready to Streamline<br class="hidden sm:block" />
              Your Supply Chain?
            </h2>
            ...
            <div class="space-y-5 sm:space-y-4">
              ...
              <div class="flex items-start sm:items-center">
                ...
                <div>
                  ...
                  <div class="text-lg sm:text-xl font-bold">
                    <a href="tel:+254725396801" class="hover:text-blue-400 transition-colors"
                      >+254 725 396 801</a
                    >
                  </div>
                </div>
              ...
              <div class="flex items-start sm:items-center">
                ...
                <div>
                  ...
                  <div class="text-lg sm:text-xl font-bold">
                    <a
                      href="mailto:wakafreight@gmail.com"
            ...
            <div class="bg-white rounded-xl shadow-2xl overflow-hidden">
              <div class="p-6 sm:p-8 text-gray-800">
                ...
                <form class="space-y-3 sm:space-y-4">
                  <!-- Name -->
                  <div>
                    <label class="block text-sm sm:text-base text-gray-700 mb-1 sm:mb-2"
                      >Name</label
                    >
                    <input
                      type="text"
